...
filepath="c-lstm/weights@epoch-{epoch:03d}-{val_acc:.2f}.hdf5"
...
model.fit(X_train, y_train, batch_size=batch_size, epochs=2, validation_data=(X_test, y_test), callbacks = [callback_tensorboard, callback_checkpoint])

...
x_train = np.empty([30000, 227, 227, 3], dtype = 'uint8')

y_train = np.empty([30000, 1], dtype = 'uint8')

y_train[0:10000] = 0
y_train[10000:20000] = 1
y_train[20000:30000] = 2
...
x_test = np.empty([7500, 227, 227, 3], dtype = 'uint8')

y_test = np.empty([7500, 1], dtype = 'uint8')

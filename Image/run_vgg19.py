...
filepath = "weights/cnn/vgg19/weights@epoch-{epoch:03d}-{val_acc:.2f}.hdf5"

tensorboard = TensorBoard(log_dir='./Graph/vgg19', histogram_freq=0, write_graph=True, write_images=True)
...
save_obj(evaluation, 'vgg19_3class')
...
filepath = "weights/cnn/lenet/weights@epoch-{epoch:03d}-{val_acc:.2f}.hdf5"
...
for index_dir, subdir in enumerate(dirs):
    ...
    for subdir, dirs, files in os.walk(train_set + subdir):
        ...
        print('Converted image from ' + subdir  + ' folder to array...')
...
classifier = Sequential()
classifier.add(Conv2D(20, (5, 5), strides = 1, input_shape = (64, 64, 3), padding = 'same', activation = 'relu'))
classifier.add(MaxPooling2D(pool_size = (2, 2), strides = 2))
classifier.add(Conv2D(50, (5, 5), strides = 1, input_shape = (64, 64, 3), padding = 'same', activation = 'relu'))
classifier.add(MaxPooling2D(pool_size = (2, 2), strides = 2))

#classifier.add(Conv2D(50, (5, 5), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
...
#classifier.add(Conv2D(256, (3, 3), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
#classifier.add(MaxPooling2D(pool_size = (2, 2), strides = 2))
#classifier.add(Conv2D(512, (3, 3), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
#classifier.add(Conv2D(512, (3, 3), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
#classifier.add(MaxPooling2D(pool_size = (2, 2), strides = 2))
#classifier.add(Conv2D(512, (3, 3), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
#classifier.add(Conv2D(512, (3, 3), strides = 1, input_shape = (227, 227, 3), padding = 'same', activation = 'relu'))
